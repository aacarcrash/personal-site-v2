...
CLUSTER_META = {
    ...
    "unreal-engine": ("Film", "Visual study", "Game engine", "Art"),
    "touchdesigner": ("Visualisation", "Visual study", "Creative coding", "Art"),
...
def main():
    # Migrate ONLY workData.json + renderData.json (the publicly displayed data).
    # The old CRA project also had unrealEngineData.json + touchDesignerData.json,
    # which were class-internal archives — never publicly linked, intentionally excluded.
...
// Source: src/{workData,renderData}.json from old CRA project.
// (unrealEngineData.json + touchDesignerData.json were class-internal — excluded.)
